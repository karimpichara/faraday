...
def upgrade():
    ...
    sa.Column('nombre_toa', sa.String(length=200), nullable=False),
    ...
    sa.Column('orden_de_trabajo', sa.String(length=200), nullable=False),
    sa.Column('empresa', sa.String(length=200), nullable=False),
    sa.Column('tecnico', sa.String(length=200), nullable=False),
    sa.Column('coord_x', sa.String(length=200), nullable=False),
    sa.Column('coord_y', sa.String(length=200), nullable=False),
    sa.Column('duracion', sa.String(length=200), nullable=False),
    sa.Column('estado', sa.String(length=200), nullable=False),
    sa.Column('fecha', sa.String(length=200), nullable=False),
    sa.Column('flag_consulta_vecino', sa.String(length=200), nullable=False),
    sa.Column('flag_estado_aprovision', sa.String(length=200), nullable=False),
    sa.Column('flag_fallas_masivas', sa.String(length=200), nullable=False),
    sa.Column('flag_materiales', sa.String(length=200), nullable=False),
    sa.Column('flag_niveles', sa.String(length=200), nullable=False),
    sa.Column('hora_flag_estado_aprovision', sa.String(length=200), nullable=False),
    sa.Column('hora_flag_fallas_masivas', sa.String(length=200), nullable=False),
    sa.Column('hora_flag_materiales', sa.String(length=200), nullable=False),
